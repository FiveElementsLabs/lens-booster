import { Box, Grid, GridItem, Stack, useColorModeValue, useMediaQuery } from '@chakra-ui/react';
  ...
  return (
    <>
      <Grid templateRows="repeat(1, 1fr)" templateColumns="repeat(9, 1fr)">
        {!isLargerThan640 && (
          <GridItem colSpan={{ base: '9', md: '3' }} mb={4}>
            <Box h="100%" borderColor="black" mb={4}>
              <DiscordAd />
            </Box>
          </GridItem>
        )}
        ...
        {isLargerThan640 && (
          <GridItem colSpan={{ base: '9', md: '3' }} mt={{ base: 10, md: 0 }} ml={{ base: 0, md: 3 }}>
            <Box h="100%" borderColor="black" mb={4}>

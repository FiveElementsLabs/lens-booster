              ...
              <Box marginLeft={5} borderRadius={8} bg="#F0F3FA" fontWeight={500} h="fit-content" py={4}>
                <Box paddingLeft={6}>
                  ...
                  <Box><InfoOutlineIcon color="#5C6F81"/></Box>
                    <Box >
                      <Text fontFamily="'Prompt', sans-serif" color="#1A4587">Estimated payoff for inflenser</Text>
                      <Text fontFamily="'Roboto', sans-serif" color={"black"} fontWeight={600}>10 $</Text>
                    </Box>
                  </Flex>
                </Box>
                ...
                <Box paddingTop={2} paddingLeft={6}>
                  <Flex gap="2">
                    <Box><InfoOutlineIcon color="#5C6F81"/></Box>
                    <Box>
                      <Text fontFamily="'Prompt', sans-serif" color="#1A4587">Remaining Budget</Text>
                      <Text fontFamily="'Roboto', sans-serif" color={"black"} fontWeight={600}>10 $</Text>
                    </Box>
                  </Flex>
                </Box>
                ...
                <Box paddingTop={2} paddingLeft={6}>
                  <Flex gap="2">
                    <Box><InfoOutlineIcon color="#5C6F81"/></Box>
                    <Box>
                      <Text fontFamily="'Prompt', sans-serif" color="#1A4587">Duration</Text>
                      <Text fontFamily="'Roboto', sans-serif" color={"black"} fontWeight={600}>10 $</Text>
                    </Box>
                  </Flex>
                </Box>
                ...
                <Box paddingTop={2} paddingLeft={6}>
                  <Flex gap="2">
                    <Box><InfoOutlineIcon color="#5C6F81"/></Box>
                    <Box>
                      <Text fontFamily="'Prompt', sans-serif" color="#1A4587"># of posts by inflensers</Text>
                      <Text fontFamily="'Roboto', sans-serif" color={"black"} fontWeight={600}>10 $</Text>
                    </Box>
                  </Flex>
                </Box>
                ...
                <Flex gap={4} fontWeight={500} >
                  <Box marginLeft={5} flexBasis="100%">
                    ...
                    _active={{
                      ...
                      bg="#F0F3FA"
                      onClick={() => useSettingState(!settingState)}>Settings
                    </Button>
                    <Box color="#1A4587" bg="#F0F3FA" px={5} pb={2} lineHeight="20px" display={settingState ? 'block' :'none'} fontSize={17}>
                      <Flex gap="2" mb={3}>
                    <Box><InfoOutlineIcon color="#5C6F81"/></Box>
                    <Box>
                      <Text fontFamily="'Prompt', sans-serif" color="#1A4587">Mirror</Text>
                      <Text fontFamily="'Roboto', sans-serif" color={"black"} fontWeight={600}>10 $</Text>
                    </Box>
                  </Flex>
                      <Flex gap="2" mb={3}>
                  ...
                  <Box flexBasis="100%">
                    <Button justifyContent="space-between" p={5} fontFamily="'Prompt', sans-serif" color="#1A4587" w="100%" rightIcon={ !statsState ? <TriangleDownIcon color="#FF6827" /> : <TriangleUpIcon color="#FF6827" />} 
                    _focus={{
                      boxShadow:
                        '0 0 0 0 rgba(88, 144, 255, .75), 0 0 0 rgba(0, 0, 0, .15)',
                    }}
                    ...
                    _hover={{ bg: '#F0F3FA' }}
                     borderBottomRadius={statsState ? '0' : '8px'}
                      bg="#F0F3FA"
                      onClick={() => setStatsState(!statsState)}>Stats</Button>
                    <Box color="#1A4587" bg="#F0F3FA" px={5} pb={2} lineHeight="20px" display={statsState ? 'block' :'none'} fontSize={17}>
                      <Flex gap="2" mb={3}>
                    <Box><InfoOutlineIcon color="#5C6F81"/></Box>
                    <Box>
                      <Text fontFamily="'Prompt', sans-serif" color="#1A4587">Mirror</Text>
